            ...
            <div className='p-6 md:p-8 space-y-6'>
                <section className='rounded-[2rem] border border-slate-200 bg-white p-6 md:p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900'>
                    <div className='flex flex-col gap-4 md:flex-row md:items-end md:justify-between'>
                        ...
                        <Link href='/instructor/new' className='rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white shadow-sm hover:bg-blue-700 whitespace-nowrap transition'>Create course</Link>
                    </div>

                    <div className='mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4'>
                        {stats.map((stat) => (
                            <div key={stat.label} className='rounded-[1.35rem] bg-slate-50 p-4 border border-slate-100 dark:border-slate-800 dark:bg-slate-950'>
                    ...
                    <div className='rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900'>
                        ...
                        <div className='mt-5 space-y-4'>
                            {[
                                ...
                                <div key={title} className='flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950'>
                                    <div>

        ...
        <div className="w-full mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <form onSubmit={handleCreate} className="space-y-6">
                ...
                <div className="pt-6 border-t border-slate-200 dark:border-slate-800 flex justify-end gap-3">
                    <Link href={`/instructor/test-series/${id}`} className="px-6 py-3 rounded-xl font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 transition-colors">Cancel</Link>

    ...
    return (
        <div className="max-w-7xl mx-auto p-6 lg:p-8 space-y-8 pb-20 flex items-center justify-center min-h-[60vh]">
            <motion.div 
                ...
                className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-3xl p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] text-center max-w-lg"
            >

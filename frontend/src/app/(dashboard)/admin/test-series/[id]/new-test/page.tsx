            ...
            <form onSubmit={handleCreate} className="space-y-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        <Link href={isSaving ? "#" : `/admin/test-series/${id}`} className={`px-6 py-2.5 rounded-xl font-bold text-slate-600 bg-slate-100 dark:bg-slate-800 dark:text-slate-300 transition-colors ${isSaving ? 'opacity-50 cursor-not-allowed pointer-events-none' : 'hover:bg-slate-200 dark:hover:bg-slate-700'}`}>Cancel</Link>

    ...
    return (
        <div className="max-w-4xl mx-auto py-12 px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
                <div className="border border-slate-200 dark:border-slate-700 rounded-2xl p-8 shadow-sm">
                ...
                <div className="border border-blue-200 dark:border-blue-900/50 bg-blue-50/50 dark:bg-blue-900/10 rounded-2xl p-8 shadow-md relative">
